...
<html lang="en">
    ...
    <center> <h3>Quotations Report</h3></center>
    ...
    <div class="row" style="margin-top: 30px">
        ...
        <div class="col">Quo. Date From:&nbsp; &nbsp; <b><?php echo $QuotationsDateFrom; ?></b></div>
        <div class="col">Quo. Date To:&nbsp; &nbsp; <b><?php echo $QuotationsDateFrom; ?></b></div>
    ...
    <div class="container">
        ...
        $QuotationsDateFrom = str_replace(' ', '', $QuotationsDateFrom);
        $QuotationsDateTo = str_replace(' ', '', $QuotationsDateTo);
        

        $sql = "SELECT * FROM quotations WHERE "
                . "BuyerID BETWEEN ' $BuyerIDFrom' AND '$BuyerIDTo' "
                . "AND 	Date  BETWEEN '$QuotationsDateFrom' AND '$QuotationsDateTo'";
        ...
        <table class="table table-striped table-sm table-bordered" >
            <thead style="background-color:#646a70; color: white; text-align: center; vertical-align: middle; height: 40px;">
                <tr>
                    ...
                    <th style="font-size: 13px; text-align: center; ">Net Amount</th>
            ...
            <tbody id="myTable">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ?>
                        <tr>
                            <td style="font-size: 12px;  vertical-align: middle; text-align: center;"><?php echo $row['quotationId'] ?></td>
                            ...
                            <td style="font-size: 12px;  vertical-align: middle; text-align: center;"><?php echo $row['NetAmount'] ?></td>  
