...
<section class="hero">
    <div class="hero-content">            
        <a href="#" id="buttonpop" class="buttonpop bttts" style="width:350px;margin-top: 100px; ">Buyer Details</a><br>
        ...
        <a href="#" id="buttonpop6" class="buttonpop bttts" style="width:350px">Payment  Details</a><br>
        <a href="#" id="buttonpop7" class="buttonpop bttts" style="width:350px">Materials stock  Details</a><br>
        <a href="#" id="buttonpop8" class="buttonpop bttts" style="width:350px">Materials suppliers  Details</a><br>
