...
<html lang="en">
    ...
    <center> <h3>Buyers Report</h3></center>
    ...
    <div class="row" style="margin-top: 30px">
        ...
        <div class="col">Reg. Date From:&nbsp; &nbsp; <b><?php echo $RegisterDateFrom; ?></b></div>
        <div class="col">Reg. Date To:&nbsp; &nbsp; <b><?php echo $RegisterDateTo; ?></b></div>
    </div>
    ...
    <div class="container">
        ...
        $BuyerIDTo = str_replace(' ', '', $BuyerIDTo);
        $RegisterDateFrom = str_replace(' ', '', $RegisterDateFrom);
        $RegisterDateTo = str_replace(' ', '', $RegisterDateTo);

        $sql = "SELECT * FROM buyerdetails WHERE "
                . "BuyerID BETWEEN ' $BuyerIDFrom' AND '$BuyerIDTo' "
                . "AND RegisteredDate BETWEEN '$RegisterDateFrom' AND '$RegisterDateTo'";
        ...
        <table class="table table-striped table-sm table-bordered" >
            <thead style="background-color:#646a70; color: white; text-align: center; vertical-align: middle; height: 40px;">
                <tr>
                    ...
                    <th style="font-size: 13px; text-align: center; ">Registered Date</th>
                    <th style="font-size: 13px; text-align: center; ">NIC_BRNo</th>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td style="font-size: 12px;  vertical-align: middle; text-align: center;"><?php echo $row['RegisteredDate'] ?></td>
                            <td style="font-size: 12px;  vertical-align: middle; text-align: center;"><?php echo $row['NIC_BRNo'] ?></td>
                            <td style="font-size: 12px;  vertical-align: middle; text-align: center;"><?php echo $row['Address'] ?></td>
                            <td style="font-size: 12px;  vertical-align: middle; text-align: center;"><?php echo $row['Email'] ?></td>                    
                            <td style="font-size: 12px;  vertical-align: middle; text-align: center;"><?php echo "0".$row['Mobile'] ?></td>
