...
<html lang="en">
    ...
    <center> <h3>Invoices Report</h3></center>
    ...
    <div class="row" style="margin-top: 30px">
        ...
        <div class="col">Inv. Date From:&nbsp; &nbsp; <b><?php echo $InvoiceDateFrom; ?></b></div>
        <div class="col">Inv. Date To:&nbsp; &nbsp; <b><?php echo $InvoiceDateTo; ?></b></div>
    ...
    <div class="container">
        ...
        $InvoiceDateFrom = str_replace(' ', '', $InvoiceDateFrom);
        $InvoiceDateTo = str_replace(' ', '', $InvoiceDateTo);
        

        $sql = "SELECT * FROM  invoice WHERE "
                . "BuyerID BETWEEN ' $BuyerIDFrom' AND '$BuyerIDTo' "
                . "AND 	Date  BETWEEN '$InvoiceDateFrom' AND '$InvoiceDateTo'";
        ...
        <table class="table table-striped table-sm table-bordered" >
            <thead style="background-color:#646a70; color: white; text-align: center; vertical-align: middle; height: 40px;">
                <tr>
                    ...
                    <th style="font-size: 13px; text-align: center; ">Last Balance</th>
            ...
            <tbody id="myTable">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ?>
                        <tr>
                            <td style="font-size: 12px;  vertical-align: middle; text-align: center;"><?php echo $row['invoiceId'] ?></td>
                            ...
                            <td style="font-size: 12px;  vertical-align: middle; text-align: center;"><?php echo $row['LastBalance'] ?></td>   
                            <td style="font-size: 12px;  vertical-align: middle; text-align: center;"><?php echo $row['DiscountRate'] ?></td> 
                            <td style="font-size: 12px;  vertical-align: middle; text-align: center;"><?php echo $row['TotalAmount'] ?></td>  
