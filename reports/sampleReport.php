...
<html lang="en">
    ...
    <center> <h3>Sample Report</h3></center>
    ...
    <div class="row" style="margin-top: 30px">
        ...
        <div class="col">Sample Date From:&nbsp; &nbsp; <b><?php echo $SampleDateFrom; ?></b></div>
        <div class="col">Sample Date To:&nbsp; &nbsp; <b><?php echo $SampleDateTo; ?></b></div>
    ...
    <div class="container">
        ...
        $SampleDateFrom = str_replace(' ', '', $SampleDateFrom);
        $SampleDateTo = str_replace(' ', '', $SampleDateTo);
        

        $sql = "SELECT * FROM samples WHERE "
                . "BuyerID BETWEEN ' $BuyerIDFrom' AND '$BuyerIDTo' "
                . "AND 	Date  BETWEEN '$SampleDateFrom' AND '$SampleDateTo'";
        ...
        <table class="table table-striped table-sm table-bordered" >
            <thead style="background-color:#646a70; color: white; text-align: center; vertical-align: middle; height: 40px;">
                <tr>
                    ...
                    <th style="font-size: 13px; text-align: center; ">Sample Date</th>
                    <th style="font-size: 13px; text-align: center; ">Buyer ID</th>
                    <th style="font-size: 13px; text-align: center; ">Order ID</th>
                    <th style="font-size: 13px; text-align: center; ">Sample Description</th>
            ...
            <tbody id="myTable">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ?>
                        <tr>
                            <td style="font-size: 12px;  vertical-align: middle; text-align: center;"><?php echo $row['SampleId'] ?></td>
                            ...
                            <td style="font-size: 12px;  vertical-align: middle; text-align: center;"><img style="width:50px " src="<?php echo $row['image'] ?>"></td>
